<?php
  include('connection.php');
    ...
    //   echo "name from billling.php -> ".$name;
    //   echo "<br/>";
      $sql="insert into pass(name, email, contact, date, dest, paid, password) values ('$name', '$email', '$contact', '$date', '$dest',0, '$password')";
    //   echo $sql;
...
// 		echo round((strtotime($date) - time())/(60*60*24));
// 		echo "\n$nod";
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="mb-5">
              ...
              <p>Provides student a pass for their daily life to travel to/from pillai college of engineering, New Mumbai</p>
            </div>
